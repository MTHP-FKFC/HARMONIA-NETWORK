...
private:
    ...
    {
        const float oversampleLatency = oversampler->getLatencyInSamples(); // уже в базовой частоте
        ...
        juce::Logger::writeToLog("Latency (analytic): os=" + juce::String(oversampleLatency, 3) +
